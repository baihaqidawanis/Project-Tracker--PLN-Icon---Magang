...
export default function Header({ darkMode, setDarkMode, sidebarCollapsed, setSidebarCollapsed }: HeaderProps) {
  return (
        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/90 mt-1">Partnership Project Tracker</p>
            </div>
          </div>
          <button
